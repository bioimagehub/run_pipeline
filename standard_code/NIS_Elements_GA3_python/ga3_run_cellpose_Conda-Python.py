...
USE_GPU = True  # Set to True if you have CUDA-capable GPU
...
# Path to conda environment with cellpose
NIS_ENVS_ROOT = r"D:\biphub\NIS-Python-envs"
CONDA_ENV = os.path.join(NIS_ENVS_ROOT, "conda_cellpose3")
...
sys.stderr.write(f"Cellpose model {{'{SELECTED_MODEL}'}} initialized (GPU: {USE_GPU})\\n")
sys.stderr.flush()
