...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser.add_argument('--remove-edges', action='store_true', help='Enable edge removal in preprocessing')
    parser.add_argument('--otsu-thresh-intensity', action='store_true', help='Use Otsu threshold for intensity')
