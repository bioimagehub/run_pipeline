...
if __name__ == "__main__":
    ...
    parser.add_argument("--mask-suffixes", nargs=2, type=str, help="list of suffixes for the masks. E.g. --mask-suffixes _cp_mask.tif _mask.tif")
    parser.add_argument("--mask-channels", nargs=2, type=str, help="list of suffixes for the masks. E.g. --mask-suffixes _cp_mask.tif _mask.tif")
